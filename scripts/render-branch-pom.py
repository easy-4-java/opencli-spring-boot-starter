...
# -*- coding: utf-8 -*-
"""
按分支名重写 opencli-spring-boot-starter 的 pom.xml。

与 opencli-java-sdk 的坐标线对齐：同一分支名使用相同版本前缀（如 3.3.x.*-SNAPSHOT），
Spring Boot parent 与编译 JDK 随线变化。
...
# (boot parent, java.version property, version prefix, use maven.compiler.release)
MATRIX = {
    ...
    "3.3.x": ("3.3.6", "17", "3.3.x", True),
    "3.4.x": ("3.4.2", "17", "3.4.x", True),
    "3.5.x": ("3.5.6", "21", "3.5.x", True),
    "4.0.x": ("4.0.6", "21", "4.0.x", True),
}
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <properties>
        ...
        <opencli-java-sdk.version>{sdk_ver}</opencli-java-sdk.version>
